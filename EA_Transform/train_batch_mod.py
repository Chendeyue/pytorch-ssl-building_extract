...
def train_dir(outdir,trainname,device,name):
    ...
    # cfg.DataSet.TRAIN_NAME = trainname
    model_list = {'train#0.01':'pretrain_model/1.pth',
                  'train#0.05':'pretrain_model/5.pth',
                  'train#0.1':'pretrain_model/10.pth',
                  'train#0.2':'pretrain_model/20.pth',
                  'train#0.5':'pretrain_model/50.pth',
                  'train#0.8':'pretrain_model/80.pth',
                  'train':'pretrain_model/100.pth'}

    dictname = trainname.split('/')[-1]
    cfg.MODEL.PREWEIGHT =model_list[dictname]
...
if __name__ == '__main__':
    ...
    out_dirs = ['model_mod_'+item.split('/')[-1] for  item in trainname_dir]
